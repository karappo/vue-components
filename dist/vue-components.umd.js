(function (global, factory) {
  ...
  var __vue_render__$1 = function() {
    ...
    var _h = _vm.$createElement;
    var _c = _vm._self._c || _h;
    return _c("div", { staticClass: "scroll", style: _vm.styles }, [
  ...
  __vue_render__$1._withStripped = true;
    ...
    var __vue_inject_styles__$1 = function (inject) {
      if (!inject) { return }
      inject("data-v-68356bbb_0", { source: "@keyframes scroll-data-v-68356bbb {\n0% {\n    transform: translate3d(0, -100%, 0);\n}\n15% {\n    transform: translate3d(0, -98%, 0);\n}\n85% {\n    transform: translate3d(0, 98%, 0);\n}\n100% {\n    transform: translate3d(0, 100%, 0);\n}\n}\n.scroll[data-v-68356bbb] {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  flex-direction: column;\n  position: absolute;\n  width: 60px;\n  bottom: 0;\n  left: calc(50% - 30px);\n}\n.scroll span[data-v-68356bbb] {\n  font-size: 12px;\n  letter-spacing: 0.05em;\n  color: var(--text-color);\n}\n.scroll i[data-v-68356bbb] {\n  display: block;\n  width: 2px;\n  height: 47px;\n  margin-top: 18px;\n  background-color: var(--gutter-color);\n  overflow: hidden;\n  position: relative;\n}\n.scroll i[data-v-68356bbb]:before {\n  display: block;\n  content: \"\";\n  width: 100%;\n  height: 100%;\n  background-color: var(--highlight-color);\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: scroll-data-v-68356bbb 2s infinite normal;\n}\n\n/*# sourceMappingURL=ScrollGuide.vue.map */", map: {"version":3,"sources":["/Users/terada/Sites/@karappo-inc/vue-components/src/components/atoms/ScrollGuide.vue","ScrollGuide.vue"],"names":[],"mappings":"AAOA;AACA;IACA,mCAAA;ACNE;ADOF;IACA,kCAAA;ACLE;ADMF;IACA,iCAAA;ACJE;ADKF;IACA,kCAAA;ACHE;AACF;ADIA;EACA,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,sBAAA;EACA,kBAAA;EACA,WAAA;EACA,SAAA;EACA,sBAAA;ACFA;ADGA;EACA,eAAA;EACA,sBAAA;EACA,wBAAA;ACDA;ADEA;EACA,cAAA;EACA,UAAA;EACA,YAAA;EACA,gBAAA;EACA,qCAAA;EACA,gBAAA;EACA,kBAAA;ACAA;ADCA;EACA,cAAA;EACA,WAAA;EACA,WAAA;EACA,YAAA;EACA,wCAAA;EACA,kBAAA;EACA,MAAA;EACA,OAAA;EACA,oDAAA;ACCA;;AAEA,0CAA0C","file":"ScrollGuide.vue","sourcesContent":["<template lang=\"pug\">\n.scroll(:style=\"styles\")\n  span SCROLL\n  i\n</template>\n\n<style lang=\"sass\" scoped>\n@keyframes scroll\n  0%\n    transform: translate3d(0, -100%, 0)\n  15%\n    transform: translate3d(0, -98%, 0)\n  85%\n    transform: translate3d(0, 98%, 0)\n  100%\n    transform: translate3d(0, 100%, 0)\n\n.scroll\n  display: flex\n  justify-content: center\n  align-items: center\n  flex-direction: column\n  position: absolute\n  width: 60px\n  bottom: 0\n  left: calc(50% - 30px)\n  span\n    font-size: 12px\n    letter-spacing: 0.05em\n    color: var(--text-color)\n  i\n    display: block\n    width: 2px\n    height: 47px\n    margin-top: 18px\n    background-color: var(--gutter-color)\n    overflow: hidden\n    position: relative\n    &:before\n      display: block\n      content: ''\n      width: 100%\n      height: 100%\n      background-color: var(--highlight-color)\n      position: absolute\n      top: 0\n      left: 0\n      animation: scroll 2s infinite normal\n</style>\n\n<script>\nimport Vue from 'vue'\nimport { isValidColor } from '@karappo-inc/util'\nexport default Vue.extend({\n  props: {\n    gutterColor: {\n      type: String,\n      default: 'rgba(0, 0, 0, 0.1)',\n      validator: (value) => {\n        if (!isValidColor(value)) throw new Error('The prop \"gutterColor\" should be valid color')\n        return true\n      }\n    },\n    highlightColor: {\n      type: String,\n      default: 'black',\n      validator: (value) => {\n        if (!isValidColor(value)) throw new Error('The prop \"highlightColor\" should be valid color')\n        return true\n      }\n    },\n    textColor: {\n      type: String,\n      default: 'black',\n      validator: (value) => {\n        if (!isValidColor(value)) throw new Error('The prop \"textColor\" should be valid color')\n        return true\n      }\n    }\n  },\n  computed: {\n    styles () {\n      return {\n        '--gutter-color': this.gutterColor,\n        '--highlight-color': this.highlightColor,\n        '--text-color': this.textColor\n      }\n    }\n  }\n})\n</script>","@keyframes scroll {\n  0% {\n    transform: translate3d(0, -100%, 0);\n  }\n  15% {\n    transform: translate3d(0, -98%, 0);\n  }\n  85% {\n    transform: translate3d(0, 98%, 0);\n  }\n  100% {\n    transform: translate3d(0, 100%, 0);\n  }\n}\n.scroll {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  flex-direction: column;\n  position: absolute;\n  width: 60px;\n  bottom: 0;\n  left: calc(50% - 30px);\n}\n.scroll span {\n  font-size: 12px;\n  letter-spacing: 0.05em;\n  color: var(--text-color);\n}\n.scroll i {\n  display: block;\n  width: 2px;\n  height: 47px;\n  margin-top: 18px;\n  background-color: var(--gutter-color);\n  overflow: hidden;\n  position: relative;\n}\n.scroll i:before {\n  display: block;\n  content: \"\";\n  width: 100%;\n  height: 100%;\n  background-color: var(--highlight-color);\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: scroll 2s infinite normal;\n}\n\n/*# sourceMappingURL=ScrollGuide.vue.map */"]}, media: undefined });

    };
    /* scoped */
    var __vue_scope_id__$1 = "data-v-68356bbb";
    /* module identifier */
  ...
  exports.AutoResizeIframe = __vue_component__;
  exports.ScrollGuide = __vue_component__$1;
  exports.SectionNav = __vue_component__$2;
  exports.Slider = __vue_component__$3;
